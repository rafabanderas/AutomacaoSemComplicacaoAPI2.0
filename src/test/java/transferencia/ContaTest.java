...
class ContaTest {
    ...
    @BeforeEach
    void setUp() {
        xuxa = new Cliente("Xuxa", "12345678900", "9876543100");
        silvioSantos = new Cliente("Silvio Santos", "00123456789", "9987654321");

        contaXuxa = new Conta("0048", "15151", 2500.00, xuxa);
        contaSilvio = new Conta("0050", "16161", 3500.00, silvioSantos);
    }
